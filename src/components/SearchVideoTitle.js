...
const SearchVideoTitle = ({ movieId, title, overview }) => {
  ...
  return (
    <div className=" text-white bg-gradient-to-r from-black">
      <h1 className=" md:py-2 text-md mt-32 w-28 md:text-lg md:w-4/12 font-bold text-gray-400">
        {title}
      </h1>
      ...
      <div className=" ">
        {/* <button className=" mr-2 px-2 py-0 md:px-4 md:py-1 bg-white bg-opacity-70 text-black md:text-lg font-bold rounded-lg mx-0 md:mt-2 mt-4  hover:bg-white">
          Play
        </button> */}
        {/* <button
...
export default SearchVideoTitle;
