...
const VideoBackground = ({ movieId }) => {
  ...
  const options = {
    ...
    headers: {
      ...
      Authorization:
        "Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiIyNjhlYzUwOTM4NWJjOTBhYjg3NWI5ODlmOWNjYzNjMSIsIm5iZiI6MTcxNzY1NTk3Ni4wNjYsInN1YiI6IjY2NjE1OWE4NmRjMjgwM2M5YjhkN2Q4ZSIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.vWqW8nj3z4Rdw6I7FScMqg8AyYUdi-VEF-Q4SbkH6iM",
    },
  };
  ...
  return (
    <div className="md:static  z-30 fixed pt-[18%]  md:pt-0 w-full">
      {trailerVideo ? (
        <iframe
