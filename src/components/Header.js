...
const Header = () => {
  ...
  return (
    <div className="bg-black md:bg-gradient-to-b from-black to-transparent z-50 md:absolute fixed w-screen md:px-8 px-4 py-1 md:py-2 flex flex-col md:flex-row justify-between">
