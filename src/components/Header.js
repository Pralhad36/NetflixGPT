...
const Header = () => {
  ...
  return (
    <div className="md:bg-gradient-to-b  from-black to-transparent bg-black z-50 md:absolute fixed w-screen md:px-8 px-4 pt-0 md:py-1 flex flex-col md:flex-row justify-between item-center">
          ...
          <div className="flex">
            {gptSearchView && (
              <select
                ...
                className=" bg-gray-800 text-xs rounded-lg text-white my-0 absolute md:top-4 top-12 p-2 left-2 md:right-52 mx-2"
              >
