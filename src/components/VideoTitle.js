...
const VideoTitle = ({ movieId, title, overview }) => {
  ...
  return (
    <div className="fixed z-40 md:z-10 flex flex-col   md:absolute w-screen md:h-[120%] h-[42%] aspect-video pt-40 md:pt-40 px-8 md:px-12 text-white bg-gradient-to-r from-black">
      ...
      <div className=" ">
        <button className=" mr-2 px-2 py-0 md:px-10 md:py-2 bg-white bg-opacity-70 text-black md:text-lg font-bold rounded-lg mx-0 md:mt-2 mt-4  hover:bg-white">
          Play
        </button>
        <button
