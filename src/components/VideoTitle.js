...
const VideoTitle = ({ movieId, title, overview }) => {
  ...
  return (
    <div className="fixed z-40 md:z-10 flex flex-col   md:absolute w-[90%] md:h-[120%] h-[49%] aspect-video pt-40 md:pt-40 px-8 md:px-12 text-white bg-gradient-to-r from-black">
